...
Генерирует research_bin/functions_ble/*.md — по одному файлу на ПОДТВЕРЖДЁННУЮ
функцию:
...
Запуск:  python gen_functions.py          (из research_bin/ или откуда угодно)
"""
import glob
import os
import re
...
FW = os.path.join(HERE, "ble_2.7.0_0015.bin")
OUT_DIR = os.path.join(HERE, "functions_ble")
