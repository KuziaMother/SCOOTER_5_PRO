...
#! -*- coding: utf-8 -*-
#
# BW Flasher — keygen (vendored)
# Copyright (C) 2024-2025 ScooterTeam
# Источник: https://github.com/scooterteam/bw-flasher, bwflasher/keygen.py
# Скопировано в проект без изменений логики (только убраны print_array/__main__).
#
# This work is licensed under the Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License.
# To view a copy of this license, visit http://creativecommons.org/licenses/by-nc-sa/4.0/
# or send a letter to Creative Commons, PO Box 1866, Mountain View, CA 94022, USA.
#
# You are free to:
# - Share — copy and redistribute the material in any medium or format
# - Adapt — remix, transform, or edit the material
#
# Under the following terms:
# - Attribution — You must give appropriate credit, provide a link to the license, and indicate if changes were made.
# - NonCommercial — You may not use the material for commercial purposes.
# - ShareAlike — If you remix, transform, or build upon the material, you must distribute your contributions under the same or compatible license.
...
def sign_rand(uid: bytes, rand: bytes, fw: bytes,
              fw_offset_0: int, fw_offset_1: int) -> bytes:
    """
    Sign challenge `rand` with key generated from `uid`,
    using tables from `fw`.
    """
    lookup_table_0 = bytearray(fw[fw_offset_0:fw_offset_0 + 256])
