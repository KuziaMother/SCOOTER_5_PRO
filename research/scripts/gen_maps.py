...
ANALYZED_MCU = [
    ...
    (0x1A5F2, "«own»: round-функция (трамплин из 0x1a628/0x1a7b8)", "§27.2, §37", "разобран"),
...
def write_mcu(path):
    ...
    A(f"Функций подтверждено детекцией: **{n}**; байт кода в функциях: **{total}** ({total/1024:.1f} КБ).")
    A("")
