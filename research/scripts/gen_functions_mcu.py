...
Генерирует research/functions_mcu/*.md — по одному файлу на ПОДТВЕРЖДЁННУЮ
функцию:
...
Запуск:  $env:PYTHONIOENCODING="utf-8"; python research/scripts/gen_functions_mcu.py
"""
import glob
import os
import re
...
OUT_DIR = os.path.join(RES, "functions_mcu")
...
"""
    ...
    idx += ["",
            "Перегенерация: `$env:PYTHONIOENCODING=\"utf-8\"; python research/scripts/gen_functions_mcu.py`.",
            "",
