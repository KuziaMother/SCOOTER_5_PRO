...
| [`0x1d640`](functions_mcu/func_0x1d640.md) | 348 | код I | **TIM init (моторный таймер-кластер @0x40012C00)**: строит descriptor'ы на стеке; 0x22000(base_code, mask, &desc) ×8 (base ∈ {0x120000, 0x480004xx}, mask = бит-канал); 0x19a9a(sp, 0x3C) — memset; struct {0x40012C00, mode=3, 0x8CA, 0, 0} → 0x22b00 + 0x22a48 (TIM1-регион §50); константы 0x8CA (2250) / 0x45B (1115) = периоды/CCR; bl 0x23040/0x22c70 (§51 DIER)/0x23544 | §52 | разобран | 100% |
