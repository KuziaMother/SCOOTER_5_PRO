...
|---|---|---|---|
| разобран | 639 | 91588 | 94.5% |
| частично | 3 | 3768 | 3.9% |
| ID | 29 | 630 | 0.6% |
| не начат | 7 | 946 | 1.0% |
| **всего** | **678** | **96932** | **96.6% декомпилировано** |
...
| [`0x1dfd8`](functions_mcu/func_0x1dfd8.md) | 344 | код I | **периодический таск USART3 (§59.6 уточнено)**: gate по byte[RAM+0x2C?] и u16-счётчику ≥ 0x620 → bl **0x1E9E0** (RX-парсер, ядро верифицировано) → bl 0x1F1CC → bl 0x1F71C → bl **0x211F8** (сборщик 'a'-кадров §47); далее u32-счётчик (clamp 0x3E8), флаг-биты 0x20/0x10 по byte[RAM+0x..], счётчик ≥ 0x1A → сброс. Тело разобрано статически; полная верификация — в TODO | §47/§59.6 | частично | 50% |
