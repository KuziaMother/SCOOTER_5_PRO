...
Функций подтверждено детекцией: **678**; байт кода в функциях: **96932** (94.7 КБ).
...
|---|---|---|---|
| разобран | 24 | 15354 | 15.8% |
| частично | 9 | 6620 | 6.8% |
| ID | 2 | 602 | 0.6% |
| не начат | 643 | 74356 | 76.7% |
| **всего** | **678** | **96932** | **19.4% декомпилировано** |
...
| [`0x1a5e6`](functions_mcu/func_0x1a5e6.md) | 12 | код I | — | — | не начат | 0% |
| [`0x1a5f2`](functions_mcu/func_0x1a5f2.md) | 8 | код I | «own»: round-функция (трамплин из 0x1a628/0x1a7b8) | §27.2, §37 | разобран | 100% |
| [`0x1a5fa`](functions_mcu/func_0x1a5fa.md) | 46 | код I | — | — | не начат | 0% |
