...
разбор PLAIN-кода: **1.9%** (взвешено по байтам; каталог ANALYZED_BLE, §63).
...
| [`0x06008`](functions_ble/func_0x06008.md) | `0x01806008` | 44 | flash-драйвер / OTA-код | **setter config-struct**: хранит arg в 3 поля [base+0/+4/+8] + callback (blx). Семья 0x6008..0x60e4 (6×44Б) — setter'ы для разных групп полей; r0=arg | §65 | частично | 50% |
...
| [`0x09f80`](functions_ble/func_0x09f80.md) | `0x01809f80` | 488 | flash-драйвер / OTA-код | **init global struct**: возвращает 4, обнуляет фикс. struct @RAM 0x2007fbe8 (leaf, аргументы игнорирует) | §65 | ID | 25% |
