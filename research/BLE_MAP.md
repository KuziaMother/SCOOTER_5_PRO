...
Подтверждено: **170** функций, всего 22988 Б кода. Семантический разбор — **0%**
(есть только авто-дизассембляция в `functions_ble/func_0x*.md`); это низкоуровневый
bootloader + flash/OTA-драйвер, «говорящий» код — в зашифрованном APP-регионе.

Перегенерация: `python research/scripts/gen_maps.py` (список функций — из
`functions_ble/README.md`).

| offset | vaddr | размер | регион | статус | % |
|---|---|---|---|---|---|
...
| [`0x063a4`](functions_ble/func_0x063a4.md) | `0x018063a4` | 46 | flash-драйвер / OTA-код | не начат | 0% |
| [`0x063d2`](functions_ble/func_0x063d2.md) | `0x018063d2` | 136 | flash-драйвер / OTA-код | не начат | 0% |
| [`0x0645e`](functions_ble/func_0x0645e.md) | `0x0180645e` | 272 | flash-драйвер / OTA-код | не начат | 0% |
